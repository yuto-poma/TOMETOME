...
$sql = $pdo -> prepare("INSERT INTO firminfo(firmname, email,situation,date,hour,minitue,wish,link,adress,others) VALUES (:firmname,:email,:situation,:date,:hour,:minitue,:wish,:link,:adress,:others)");
   $sql -> bindValue(':firmname', $_POST['firmname'], PDO::PARAM_STR);
	$sql -> bindValue(':email', $_SESSION['email'], PDO::PARAM_STR);
	$sql -> bindValue(':situation', $_POST['situation'], PDO::PARAM_STR);
	$sql -> bindValue(':date', $_POST['date'], PDO::PARAM_STR);
	$sql -> bindValue(':hour', $_POST['hour'], PDO::PARAM_STR);
	$sql -> bindValue(':minitue', $_POST['minitue'], PDO::PARAM_STR);
	$sql -> bindValue(':wish', $_POST['wish'], PDO::PARAM_STR);
	$sql -> bindValue(':link', $_POST['link'], PDO::PARAM_STR);
	$sql -> bindValue(':adress', $_POST['adress'], PDO::PARAM_STR);
	$sql -> bindValue(':others', $_POST['others'], PDO::PARAM_STR);
	$sql -> execute();	
...
<body>
<form method="post" ><div class="cp_iptxt"><lavel class="ef"><input type="text" size="60" name="firmname" placeholder="企業名(※必須)" required></label></div><br>
...
<div class="cp_ipselect cp_sl02">
<select name="wish" class="wish" reqired>
...
<input type="submit"  class="btn-circle-border-simple"  name="add" value="ADD"/>
</form>
</body>
